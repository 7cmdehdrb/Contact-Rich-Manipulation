#!/usr/bin/env python3
"""Train the sweep policy without current target-pose observations.

This registers the tactile-localization task and delegates to IsaacLab's stock
RSL-RL trainer, leaving every existing source file unchanged.
"""
...
TASK_ID = "Isaac-Sweep-Object-UR5e-OSC-TactileLocalization-v0"
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": (
            "sweep_rl.osc_sweep.agents.rsl_rl_ppo_cfg_tactile_localization:"
