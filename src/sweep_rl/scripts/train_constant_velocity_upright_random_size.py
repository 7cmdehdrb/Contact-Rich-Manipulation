#!/usr/bin/env python3
"""Train the upright-gripper, random-cube-size constant-velocity task."""
...
TASK_ID = "Isaac-Sweep-Object-UR5e-OSC-ConstantVelocity-UprightRandomSize-v0"
