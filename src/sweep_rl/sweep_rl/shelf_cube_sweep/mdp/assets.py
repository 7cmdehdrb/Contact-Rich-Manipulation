"""V1 Cube spawner with explicit center of mass and inertia."""
...
def spawn_bottom_heavy_cuboid(
    ...
    **kwargs,
    ...
    """Spawn a normal Cuboid and author ballast-equivalent mass properties."""
...
class BottomHeavyCuboidCfg(CuboidCfg):
    """Cuboid with explicit local-frame COM and principal inertia."""
