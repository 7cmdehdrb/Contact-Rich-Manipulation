...
기본 코드는
[`OscSweepSceneCfg`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg.py)에 있다. 이후
...
- scene 정의:
  [`CanSweepHomeSceneCfg`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg_constant_velocity_upright_random_size_home_can.py)
- MassAPI 생성 함수:
  [`define_rigid_object_mass()`](../../sweep_rl/sweep_rl/osc_sweep/mdp/events.py)
- `prestartup` 연결:
  `CanSweepHomeEventsCfg.set_target_mass`
- CLI 연결:
  [`play_constant_velocity_home_can.py`](../../sweep_rl/scripts/play_constant_velocity_home_can.py)
