...
구현 연결은 기본
[`EventCfg`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg.py)와 Independent
[`EventsCfg`](../../sweep_rl/sweep_rl/osc_sweep_independent/env_cfg.py)다.
...
구현은
[`IndependentSweepOscAction.reset()`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp/actions.py)에
...
[`FeasibleSweepHomeCommand`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp/commands.py)다.
...
[`osc_sweep_independent/mdp/observations.py`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp/observations.py),
