...
현재 사용자 USD의 실제 예시는
[`CanSweepHomeSceneCfg`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg_constant_velocity_upright_random_size_home_can.py)다.
...
- 구현: [`osc_sweep_independent/mdp/events.py`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp/events.py)
- 활성화 위치: [`EventsCfg`의 주석 처리된 logger](../../sweep_rl/sweep_rl/osc_sweep_independent/env_cfg.py)
