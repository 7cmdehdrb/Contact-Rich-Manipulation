...
구현 위치는
[`Independent EventsCfg`](../../sweep_rl/sweep_rl/osc_sweep_independent/env_cfg.py)의
...
기본값은
[`OscSweepSceneCfg.target_object`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg.py)의 static 0.65,
...
[`print_reset_physics_info()`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp/events.py)는
