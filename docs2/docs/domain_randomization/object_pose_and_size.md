...
기본 구현은
[`reset_target_object()`](../../sweep_rl/sweep_rl/osc_sweep/mdp/events.py), Independent 구현은
[`reset_variable_size_target()`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp/events.py)다.
...
현재 Can 매핑은
[`OPEN_TABLE_TOP_HEIGHT`, `CAN_HEIGHT`, `CAN_OBSERVATION_Z_OFFSET`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg_constant_velocity_upright_random_size_home_can.py)를
