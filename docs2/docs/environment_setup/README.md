...
| 경로 | 역할 |
|---|---|
| [`osc_sweep/assets.py`](../../sweep_rl/sweep_rl/osc_sweep/assets.py) | UR5e와 gripper를 조립하고 virtual links/contact pads 생성 |
| [`osc_sweep/env_cfg.py`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg.py) | open table, cube, 기본 pad sensor scene |
| [`osc_sweep/mdp`](../../sweep_rl/sweep_rl/osc_sweep/mdp) | observation, reward, termination, action, reset 구현 |
| [`osc_sweep_independent/env_cfg.py`](../../sweep_rl/sweep_rl/osc_sweep_independent/env_cfg.py) | shelf USD, 전신 contact sensor, independent scene |
| [`osc_sweep_independent/mdp`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp) | 3-phase shelf task와 domain randomization |
