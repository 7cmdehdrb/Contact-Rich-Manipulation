...
두 환경 계열은
[`make_ur5e_robotiq_ft_cfg()`](../../sweep_rl/sweep_rl/osc_sweep/assets.py)가 반환하는 하나의
...
[`spawn_ur5e_robotiq_ft()`](../../sweep_rl/sweep_rl/osc_sweep/assets.py)에서 조립한다.
...
관측 구현은
[`virtual_ft_wrench_b()`](../../sweep_rl/sweep_rl/osc_sweep/mdp/observations.py)다.
...
[`target_contact_data_w()`](../../sweep_rl/sweep_rl/osc_sweep/mdp/common.py)는 두 pad의 force를
...
- 설정: [`SweepHomeSceneCfg`](../../sweep_rl/sweep_rl/osc_sweep/env_cfg_constant_velocity_upright_random_size_home.py)
...
[`ROBOT_CONTACT_FILTERS`, `make_robot_body_contact_sensor()`](../../sweep_rl/sweep_rl/osc_sweep_independent/env_cfg.py)와
[`robot_shelf_collision()`, `robot_self_collision()`](../../sweep_rl/sweep_rl/osc_sweep_independent/mdp/terminations.py)에
있다.
